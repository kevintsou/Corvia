...
class MdReporter(BaseReporter):
    def generate(self, result: AnalysisResult) -> str:
        ...
        lines.append("# COVIA Analysis Report\n")
        lines.append(f"**COVIA v{__version__}** | Files analyzed: {summary['total_files']} | Total issues: {summary['total_issues']}\n")
        ...
        lines.append("---\n")
        lines.append(f"*Generated by COVIA v{__version__}*\n")
